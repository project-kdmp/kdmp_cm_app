...
class PaymentRepositoryImpl extends PaymentRepository {
  ...
  @override
  Future<StateAPI> deleteCardInfo({required DeleteCardInfoRequest deleteCardInfoRequest}) async {
    const api = '/v1/biztotal/cm/drv/delCardInfo';
    final url = '${AppConstants.API}$api';

    try {
      final response = await _dio.post(
        url,
        data: deleteCardInfoRequest.toJson(),
        options: Options(contentType: Headers.jsonContentType),
      );
